...
class AlgorithmsPanel(tk.Frame):
    def __init__(self, parent, *, on_select_algorithm: Callable[[str], None], on_compare: Callable[[], None], **kwargs):
        ...
        tk.Frame(self, height=2, bg="#f5f6fa").pack(fill=tk.X, pady=10)
        make_button(self, "Compare All", on_compare, COLORS["accent"]).pack(fill=tk.X, pady=5)
